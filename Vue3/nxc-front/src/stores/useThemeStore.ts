...
const useThemeStore = defineStore('theme', {
    state: () => {  // state 需要是一个函数 有返回值
        return {
            theme1: {
                commonLogoBgColor: '#324f85',
                commonHeaderBgColor: '#385894',
                commonAsideBgColor: '#fff',
                commonContentBgColor: '#eff2f7',
            },
            theme2: {
                commonLogoBgColor: '#324f85',
                commonHeaderBgColor: '#385894',
            ...
            fontColor: '#fff',
            globalTheme: [lightTheme, darkTheme, myLightTheme],
            nowThemeCode: 0,
        }
    }
})

const myLightTheme = reactive({
        "name": "common",
